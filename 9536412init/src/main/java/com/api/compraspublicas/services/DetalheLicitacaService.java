...
public class DetalheLicitacaService {
	...
	@Autowired
	private UnidadeCompradoraService unidadeCompradora;
	...
	public String save(DetalheLicitacao obj) {
		...
		if (detalhe != null) {
			...
			obj.getUnidadeCompradora().setDetalheLicitacao(obj);			
			UnidadeCompradora unidade = obj.getUnidadeCompradora();
			obj.setUnidadeCompradora(null);
			...
			unidadeCompradora.save(unidade);
