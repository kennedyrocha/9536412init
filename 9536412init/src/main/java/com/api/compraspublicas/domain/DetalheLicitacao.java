...
public class DetalheLicitacao implements Serializable {
	...
	@OneToOne(mappedBy = "detalheLicitacao")
	@JsonProperty("unidadeCompradora")
	private UnidadeCompradora unidadeCompradora;
	...
	public List<Reinicio> getReinicios() {
		return reinicios;
	}
	...
	public UnidadeCompradora getUnidadeCompradora() {
		return unidadeCompradora;
	}

	public void setUnidadeCompradora(UnidadeCompradora unidadeCompradora) {
