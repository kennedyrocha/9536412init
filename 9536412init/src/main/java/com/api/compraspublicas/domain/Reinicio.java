...
@Entity
public class Reinicio implements Serializable{
	...
	@ElementCollection
	@CollectionTable(name="CD_ARQUIVO_REINICIO")
	...
	public Reinicio(Integer id, String tipoEvento, String siglaLicitacon, String data, String hora, String evento,
