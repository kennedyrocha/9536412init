...
public class Encerramento implements Serializable{
	...
	@ElementCollection
	@CollectionTable(name="CD_ARQUIVO_ENCERRAMENTO")
	...
	public Encerramento(Integer id, String tipoEvento, String siglaLicitacon, String data, String hora, String evento,
