...
@Entity
public class Revogacao implements Serializable{
	...
	@ElementCollection
	@CollectionTable(name="CD_ARQUIVO_REVOGACAO")
	...
	public Revogacao(Integer id, String tipoEvento, String siglaLicitacon, String data, String hora, String evento,
